...
it might be useful for our analysis. But first of all, let's install some
packages that will be useful in this analysis.
...
```{r}
# Removing rows with missing values in attack or defense columns
...
# Adding cluster labels to variables data frame
newvariables$cluster <- as.factor(kmeans_variables$cluster)

# Plotting variables with cluster labels
